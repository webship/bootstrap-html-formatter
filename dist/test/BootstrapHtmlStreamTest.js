...
const BootstrapHtmlStream_1 = __importDefault(require("../src/BootstrapHtmlStream"));
function renderAsHtml(...envelopes) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            ...
            const bootstrapHtmlStream = new BootstrapHtmlStream_1.default(`${__dirname}/dummy.css`, `${__dirname}/dummy.js`);
...
//# sourceMappingURL=BootstrapHtmlStreamTest.js.map